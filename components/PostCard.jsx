  ...
  <div style={{backgroundColor:"#D9D9D9"}} className="bg-[#D9D9D9] shadow-lg rounded-lg p-0  pb-12 mb-8">
    ...
    <div className="text-center">
      <Link href={`/post/${post.slug}`}>
        <span style={{backgroundColor:"#35185A"}} className="transition duration-500 ease transform hover:-translate-y-1 inline-block bg-[#35185A] text-lg font-medium rounded-full text-white px-8 py-3 cursor-pointer">Continue Reading</span>
      </Link>
    </div>
  </div>
);
